...
$greek = [
    ...
    "user_name" => "User",
    "User Id" => "Χρήστης",
    "Leave Location Name" => "Τοποθεσίας",
    "Price" => "Τιμή €",
    "Leave Location ID" => "Τοποθεσία Παράδοσης",
    "Pick Location ID" => "Τοποθεσία Παραλαβής",
    "Leave" => "Άφησες",
    "Calendar" => "Ημερολόγιο",
    "Calendar Incoming" => "Ημερολόγιο Παραλαβές / Παραδόσεις",
    "Calendar Current" => "Τρέχον Ημερολόγιο",
    "Create Book" => "Δημιουργία Κράτησης",
    "Books" => "Κρατήσεις",
    "book" => "Κράτηση",
    "Bookings" => "Κρατήσεις",
    "booking" => "Κράτηση",
    "Create Booking" => "Δημιουργία Κράτησης",
    "Save" => "Αποθήκευση",
    "Pick" => "Μάζεψες",
    "Start Date" => "Ημερομηνία Έναρξης",
    "End Date" => "Ημερομηνία Λήξης",
    "Customer ID" => "Προσωπικό",
    "Vehicle ID" => "Όχημα",
    ...
    "Maintenance Costs" => "Συντήρηση Κόστος €",
    "Booking Earn" => "Κέρδος Κρατήσεων €",
    "Total Earn" => "Συνολικό Κέρδος €",
    "Category" => "Κατηγορία",
    "Plate" => "Πινακίδα",
    "Name" => "Όνομα",
    "Fistname" => "Όνομα",
    "Password Repeat" => "Επαλήθευση Κωδικού",
    "Date Born" => "Ημερομηνία Γέννησης",
    "Address" => "Διεύθυνση",
    "Country" => "Χωρά",
    "City" => "Πόλη",
    "User" => "Χρήστης",
    ...
    "Create User" => "Δημιουργία Χρηστών",
    "Create Maintenance" => "Δημιουργία Συντήρηση",
    "Description" => "Περιγραφή",
    "Date" => "Ημερομηνία",
    "Customer" => "Προσωπικό",
    "Customers" => "Προσωπικό",
    "Create Customer" => "Δημιουργία Προσωπικού",
    "comments" => "Σχόλια",
    "Diploma" => "Δίπλωμα",
    "Location" => "Τοποθεσία",
    ...
    "Company" => "Εταιρία",
    "Companies" => "Εταιρίες",
    "Create Company" => "Δημιουργία Εταιρίας",
    "Pretty Name" => "Όμορφο Όνομα",
    ...
    "Steps" => "Βήματα",
    "Create Steps" => "Δημιουργία Βημάτων για Χρήστη",
    "Calories" => "Θερμίδες",
    "Meals" => "Γεύματα",
    "Weight" => "Βάρος",
    "Create Meal" => "Δημιουργία Βημάτων",
    "Food Category" => "Κατηγορία Ερώτησης",
    "Food Categories" => "Κατηγορίες Ερωτήσεων",
    "Create Food Category" => "Δημιουργία Κατηγορία Ερωτήσεις",
    "User Weights" => "Βάρη Χρηστών",
    "User Weight" => "Βάρος Χρήστη",
    "Create User Weight" => "Δημιουργία Βάρος Χρήστη",
    "Food Answer Cell Answers" => "Ερωτήσεις απαντήθηκαν",
    "Food Answer Cell Answer" => "Ερωτήσεις απαντήθηκαν",
    "Create Food Answer Cell Answer" => "Δημιουργία Απαντημένων Ερωτήσεων",
    "Food Answers" => "Απαντήσεις",
    "Food Answer" => "Απάντηση",
    "Create Food Answer" => "Δημιουργία Απάντησης",
    "Dashboard" => "Ταμπλό",

    "Question Category" => "Κατηγορία Ερώτησης",
    "Create Question Category" => "Δημιουργία Κατηγορία Ερώτησης",
    "Meal Category" => "Κατηγορία Γεύματος",
    "Serving" => "Σερβίρισμα",
    "Total Calories" => "Συνολικές Θερμίδες",
    "Amount" => "Ποσότητα",
    "Question" => "Ερώτηση",
    "Score" => "Σκορ",
    "Cell Answer" => "Κελί Απάντηση",
    "Total Points" => "Συνολικοί Πόντοι",
    "Med Score" => "Med Πόντοι",
    "Genders of all Users" => "Φύλο όλων των χρηστών",
    "Monthly Questions" => "Μηνιαίες ερωτήσεις",
    "Question Categories" => "Κατηγορίες Ερωτήσεων",
    "Image Upload" => "Εικόνα",
    "Image" => "Εικόνα",
    "Height" => "Ύψης",
    "Phone" => "Κινήτο Τηλέφωνο",
    "Email" => "Email",
    "Gender" => "Γένος",
    "Update" => "Ενημέρωση",
    "Hi" => "Γειά",
    ...
    "Graphs" => "Γραφήματα",
    "Can't be accessed" => "Δεν μπορει να προσπελαστει",
    "Greek" => "Ελληνικά",
    "Car Diploma" => "Δίπλωμα Αυτοκινήτου",
    "Create Car Diploma" => "Δημιουργία Δίπλωμα Αυτοκινήτου",
    "Update Car Diploma" => "Ενημέρωση Δίπλωμα Αυτοκινήτου",
    "Car Diplomas" => "Διπλώματα Αυτοκινήτων",
    "Computer Skills" => "Γνώσεις Η/Υ",
    "Create Computer Skills" => "Δημιουργία Γνώσεις Η/Υ",
    "Update Computer Skills" => "Ενημέρωση Γνώσεις Η/Υ",
    "Family Status" => "Οικογενειακή Κατάσταση",
    "Family Statuses" => "Οικογενειακές Καταστάσεις",
    "Home Phone" => "Σταθερό Τηλέφωνο",
    "County Residence" => "Νομός Κατοικίας",
    "County Residences" => "Νομός Κατοικίας",
    "City Residence" => "Περιοχή / Πόλη Κατοικίας",
    "Military Duties" => "Εκπληρωμένες Στρατιωτικές Υποχρεώσεις",
    "Field1" => "Πεδίο 1",
    "Field2" => "Πεδίο 2",
    "Field3" => "Πεδίο 1",
    "General Knowledge" => "Γενικές γνώσεις",
    "PC General Knowledge" => "Η/Υ Γενικές γνώσεις",
    "PC General Knowledges" => "Η/Υ Γενικές γνώσεις",
    "Genders" => "Γένοι",
    "Degree" => "Σπουδές",
    "Customer Degree" => "Σπουδές",
    "Degrees" => "Σπουδές",
    "Study Degree" => "Σπουδές",
    "Study Degrees" => "Σπουδές",
    "Speciality" => "Ειδικότητα",
    "Specialities" => "Ειδικότητες",
    "Foreign Language" => "Ξένη γλώσσα",
    "Foreign Languages" => "Ξένες γλώσσες",
    "English Diploma" => "Αγγλικό διπλώμα",
    "English Diplomas" => "Αγγλικά διπλώματα",
    "Other Languages"=>"Λοιπές γλώσσες",
    "Professional Experience" => "Επαγγελματική εμπειρία",
    "Professional Experiences" => "Επαγγελματικές εμπειρίες",
    "Last Job Title" => "Τελευταίος Τίτλος Θέσης",
    "Last Company Worked" => "Τελευταία Επωνυμία Εταιρίας που Εργάστηκε",
    "Knows Photovoltaic" => "Έχει γνώσεις Φωτοβολταϊκών;",
    "Knows Current" => "Γνώσεις χειρισμών μέσης τάσης;",
    "File" => "Αρχείο",
    "Files" => "Αρχεία",
    "Interview"=>"Συνέντευξη",
    "Title" => "Όνομα",
    "Job Title" => "Τίτλος θέσης",
    "Job Titles"=>"Τιτλοί θέσεων",
    "Complete Interview"=>"Πραγματοποιήθηκε συνέντευξη",
    "Phone Communication"=>"Έγινε Τηλεφωνική Επικοινωνία",
    "Asking Job" => "Θέση για την οποία έγινε επικοινωνία",
    "Comments" => "Σχόλια",
    "Biography File"=>"Βιογραφικό αρχείο",
    "Select"=>"Επιλογή",
    "Search"=>"Αναζήτηση",
    "Edit"=>"Επεξεργασία",
    "New"=>"Νέο",
    "Secondary"=>"Δευτερεύων",
    "{user} created {customer}!"=>"Ο/Η {user} δημιουργήσε {customer}!",
    "Data were saved for "=>"Αποθηκέυτηκαν τα δεδομένα για ",
    "User Notifications"=>"Ειδοποιήσεις χρήστη",
    "Alerts"=>"Ειδοποιήσεις",
    "Phd"=>"Διδακτορικό",
    "Phds"=>"Διδακτορικά",
    "Master"=>"Μεταπτυχιακό",
    ...
    "Date Interview"=>"Ημερομηνία συνέντευξης",
    "Date Biography Arrival"=>"Μήνας-έτος άφιξης βιογραφικού",
    "Full List"=>"Πλήρης λίστα",
    "Pcerps" => "PC ERP",
    "PC Auto Cads"=>"PC Auto Cad",
    "PC Pvsysts" => "PC PVSYST",
    "Create County Residence" => "Δημιουργία Νομός Κατοικίας",
    "Update County Residence"=>"Ενημέρωση Νομός Κατοικίας",
    "Create English Diploma"=>"Δημιουργία Αγγλικά διπλώματα",
    "Update English Diploma"=>"Ενημέρωση Αγγλικά διπλώματα",
    "Create Family Status"=>"Δημιουργία Οικογενειακές Καταστάσεις",
    "Update Family Status"=>"Ενημέρωση Οικογενειακές Καταστάσεις",
    "Create Gender" => "Δημιουργία Γένους",
    "Update Gender" => "Ενημέρωση Γένους",
    "Create Job Title" => "Δημιουργία Τιτλοί θέσεων",
    "Update Job Title" => "Ενημέρωση Τιτλοί θέσεων",
    "Create Master" => "Δημιουργία Μεταπτυχιακά",
    "Update Master" => "Ενημέρωση Μεταπτυχιακά",
    "Create Phd" => "Δημιουργία Διδακτορικό",
    "Update Phd" => "Ενημέρωση Διδακτορικό",
    "Create PC Auto Cad"=>"Δημιουργία PC Auto Cad",
    "Update PC Auto Cad"=>"Ενημέρωση  PC Auto Cad",
    "Create Pcerp" => "Δημιουργία PC ERP",
    "Update Pcerp" => "Ενημέρωση  PC ERP",
    "Create PC General Knowledge" => "Δημιουργία Η/Υ Γενικές γνώσεις",
    "Update PC General Knowledge" => "Ενημέρωση Η/Υ Γενικές γνώσεις",
    "Create PC Pvsyst" => "Δημιουργία PC PVSYST",
    "Update PC Pvsyst" => "Ενημέρωση PC PVSYST",
    "Create Skill" => "Δημιουργία Ικανότητας",
    "Update Skill" => "Ενημέρωση Ικανότητας",
    "Create Speciality" => "Δημιουργία Ειδικότητας",
    "Update Speciality" => "Ενημέρωση Ειδικότητας",
    "Create Study Degree"=>"Δημιουργία Σπουδών",
    "Update Study Degree"=>"Ενημέρωση Σπουδών"
...
return array_merge($greek, $default);
?>
