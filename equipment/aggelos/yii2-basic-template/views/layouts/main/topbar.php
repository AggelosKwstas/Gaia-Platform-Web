    ...
    <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
        ...
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a href="./index.php?r=workbench"
                                                                                          target="_blank"
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround">
                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                    <li class="kt-nav__item <?=$active_en?> ">
                        <a href="index.php?r=site/locale&name=en" class="kt-nav__link">
                    ...
                    <li class="kt-nav__item <?=$active_gr?> ">
                        <a href="./index.php?r=site/locale&name=el-GR" class="kt-nav__link">
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" aria-expanded="false" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    <img alt="Pic" class="kt-radius-100" src="<?= Yii::$app->user->identity->image ?>"/>
