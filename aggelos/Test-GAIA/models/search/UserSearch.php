...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'gender_id', 'user_type_id', 'status'], 'integer'],
            [['username', 'firstname', 'lastname', 'image', 'token',"gender_name", 'auth_key', 'password_hash', 'password_reset_token', 'email', 'date_created', 'date_updated'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'username', $this->username])
            ...
            ->andFilterWhere(['like', 'CONVERT(date,user.date_created)', $this->date_created])
