...
-- Χρόνος δημιουργίας: 03 Μάη 2023 στις 15:02:42
...
--
-- Δομή πίνακα για τον πίνακα `gender`
--

CREATE TABLE `gender` (
  `id` int(11) NOT NULL,
  `name` varchar(127) COLLATE utf8_unicode_ci NOT NULL,
  `pretty_name` varchar(127) COLLATE utf8_unicode_ci NOT NULL,
  `date_created` timestamp NOT NULL DEFAULT current_timestamp(),
  `date_updated` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Άδειασμα δεδομένων του πίνακα `gender`
--
...
--
-- Δομή πίνακα για τον πίνακα `image`
--
...
CREATE TABLE `image` (
  ...
  `thumbnail_path` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Άδειασμα δεδομένων του πίνακα `image`
--
...
(35, 'Aggelos_admin', 'Aggelos', 'Kwstas', 10, 1, NULL, '6947011764', '', '', '5dLNYonh9NGRUlNEonNBVRGQs_QePahr', '2000-03-23', 0, 'LZIoujgiccrXjGzR2dDsQyFA1Qo693IE', '$2y$13$akDDCFmxoJE8Tj.PJilx/OoZ/Lp8U7dNEZG13LbUoKKMyQOJqJl8i', '5dLNYonh9NGRUlNEonNBVRGQs_QePahr', 'agelos.kostas21@gmail.com', 10, NULL, NULL, '2023-04-21 12:13:44');
...
(2, 'simple_user', 'Simple User', '2020-03-24 15:04:03', '2020-12-27 08:18:57'),
...
--
-- Ευρετήρια για πίνακα `gender`
--
ALTER TABLE `gender`
  ADD PRIMARY KEY (`id`);

--
-- Ευρετήρια για πίνακα `image`
--
ALTER TABLE `image`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT για πίνακα `gender`
--
ALTER TABLE `gender`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT για πίνακα `image`
--
ALTER TABLE `image`
...
--
-- AUTO_INCREMENT για πίνακα `user_type`
--
ALTER TABLE `user_type`
